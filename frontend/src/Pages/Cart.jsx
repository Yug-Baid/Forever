...
const Cart = () => {
  ...
  return (
    <div className='border-t pt-14 px-20'>
      ...
      <div className='flex flex-col w-full sm:w-[450px] justify-self-end mb-20 mt-20'>
        <CartTotal/>
        <div className=' bg-black text-white p-5 rounded-xl w-[250px] ml-auto text-center'>
